...
const FilterSection: React.FC<FilterSectionProps> = ({ filters, onFilterChange, onExport, isLoading, language = 'en' }) => {
    ...
    return (
        <div className="bg-gray-900 border-b border-gray-800 px-6 py-4">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                >
                    <Download size={18} />
                    {isLoading ? (isAr ? 'جارٍ التصدير...' : 'Exporting...') : (isAr ? 'تصدير CSV' : 'Export CSV')}
                </button>
            </div>
        </div>
    );
