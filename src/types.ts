...
export enum ViewMode {
  ...
  ROUTE_SEQUENCE_V2 = 'ROUTE_SEQUENCE_V2',
  INSIGHTS_V2 = 'INSIGHTS_V2',
  MARKET_SCANNER_V2 = 'MARKET_SCANNER_V2',
  ANALYZE_DATA = 'ANALYZE_DATA',
  LICENSE_SUMMARY = 'LICENSE_SUMMARY',
  COMPANY_SETTINGS_V2 = 'COMPANY_SETTINGS_V2',
  AI_OPTIMIZER_V2 = 'AI_OPTIMIZER_V2',
  DATA_ASSIST_V2 = 'DATA_ASSIST_V2',
  SMART_WORKFLOWS = 'SMART_WORKFLOWS',
  DETAILED_REPORTS_V2 = 'DETAILED_REPORTS_V2'
}
